...
exports.default = function (schema, opts) {
  ...
  (0, _assert2.default)(!schema.methods._patchData, 'conflicting instance method: `_patchData`');
  ...
  function createPatch(document) {
    ...
    var ops = _fastJsonPatch2.default.compare(document.isNew ? {} : document._original || {}, toJSON(document._patchData()));
  ...
  function preUpdateOne(next) {
    ...
    this.model.findOne(this._conditions).then(function (original) {
      ...
      _this2._original = toJSON(original._patchData());
    }).then(function () {
      return next();
    }).catch(next);
  }
